...
// A porta deve ser lida de process.env.PORT, que é injetada pelo Railway (8080)
...
// ---------------- BANCO DE DADOS ----------------
// USANDO AS VARIÁVEIS DB_HOST, DB_USER, etc., CONFIGURADAS NO PAINEL DO RAILWAY
const db = mysql.createConnection({
    host: process.env.DB_HOST, // Alterado para DB_HOST
    user: process.env.DB_USER, // Alterado para DB_USER
    password: process.env.DB_PASS, // Alterado para DB_PASS
    database: process.env.DB_NAME, // Alterado para DB_NAME
    port: process.env.DB_PORT // Alterado para DB_PORT
});
...
if (!MP_ACCESS_TOKEN || !WHATSAPP_TOKEN || !WHATSAPP_PHONE_ID) {
    console.log("\n❗ Faltando variáveis no .env (Verifique no Railway Variables):");
